...
// Ported unchanged from the desktop app's src/lib/kind-colors.ts so the
// site's graph, reference table, and cleanup list use the exact same
// resource-kind family colors as the shipped product — never a site-only
// re-derivation of the palette.
